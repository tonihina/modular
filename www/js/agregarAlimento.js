...
$(function(){
    $("#guardarAlimento").click(function(){
      ...
      $.ajax({
        type:"POST",
        url: "http://localhost/php/insertarComida.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
  ...
  $.ajax({
          type: "POST",
          url: "http://localhost/php/caloriasTotales.php",
  ...
  $.ajax({
      type: "POST",
      url: "http://localhost/php/contarMacrosDiarios.php",
      data: macrosTodo,
      cache: false,
      beforeSend: function() {
  ...
  $.ajax({
          type: "POST",
          url: "http://localhost/php/contarCalorias.php",
          data: dataString,
          cache: false,
          beforeSend: function() {
  ...
  $.ajax({
      type: "POST",
      url: "http://localhost/php/contadorMacros.php",
      data: macrosD,
      cache: false,
      beforeSend: function() {
...
$.ajax({
      type: "POST",
      url: "http://localhost/php/detalleDesayuno.php",
...
$.ajax({
    type: "POST",
    url: "http://localhost/php/macrosTotalesGrafica.php",
...
$.ajax({
    type: "POST",
    url: "http://localhost/php/macrosComidasGrafica.php",
