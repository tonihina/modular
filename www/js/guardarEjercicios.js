function flexiones(){
    ...
    $.ajax({
        type:"POST",
        url: "http://localhost/php/actualizaFlexiones.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function sentadillas(){
    ...
    $.ajax({
        type:"POST",
        url: "http://localhost/php/actualizaSentadillas.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function abdominales(){
    ...
    $.ajax({
        type:"POST",
        url: "http://localhost/php/actualizaAbdominales.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function fondos(){
    ...
    $.ajax({
        type:"POST",
        url: "http://localhost/php/actualizaFondos.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
