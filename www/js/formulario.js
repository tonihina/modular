$(function(){
  $("#guardardatos").click(function(){
    ...
    $.ajax({
      type:"POST",
      url: "http://localhost/php/insertar.php",
      data: dataString,
      crossDomain: true,
      cache: false,
      beforeSend: function() {
  ...
  $(function(){
      $('form').submit(function(){
          ...
          $.ajax({
              ...
              url: 'http://localhost/php/conexion.php',
              success: function(data){
                  console.log(data);
...
$(document).ready(function(){
  $("#botonLogin").click(function(){
      ...
      var fpeso = $("#peso").val();
      $.post("http://localhost/php/conexion.php",{ nombre: fnombre, edad: fedad, altura: faltura, sexo: fsexo, 
