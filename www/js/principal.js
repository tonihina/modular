$(document).ready(function() {
  ...
  $.ajax({
    type: "POST",
    url: "http://localhost/php/mostrarImagen.php",
    cache: false,
...
$(document).ready(function() {
  ...
  $.ajax({
    type: "POST",
    url: "http://localhost/php/mostrarPublicaciones.php",
    cache: false,
    beforeSend: function() {
...
$(document).ready(function() {
  ...
  $.ajax({
    type: "POST",
    url: "http://localhost/php/mostrarRetos.php",
    cache: false,
    success: function(response)
    {
...
$(function(){
  $("#botonPublicarHistoria").on("click", function(){
      ...
      var ruta = "http://localhost/php/subirHistoria.php";
      $.ajax({
          url: ruta,
          type: "POST",
          data: formData,
...
$(function(){
  $("#botonPublicar").on("click", function(){
    ...
    var ruta = "http://localhost/php/subirPublicacion.php";
...
$(document).ready(function() {
  $.ajax({
          type: "POST",
          url: "http://localhost/php/mostrarHistorias.php",
          cache: false,
...
function detalleHistoria(usuario){
  $.ajax({
    type: "POST",
    url: "http://localhost/php/mostrarDetalleHistoria.php",
    cache: false,
    data: "nombre="+usuario,
    beforeSend: function() {
...
var items = [
    {
        src: 'http://localhost/php/historias/'+data[i].imagen,
        w: 600,
        h: 400
    }
];
